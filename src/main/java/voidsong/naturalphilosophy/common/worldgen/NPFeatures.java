...
public class NPFeatures {
    ...
    public static final DeferredHolder<Feature<?>, Feature<WaterPlantConfiguration>> SEAGRASS = FEATURES.register("seagrass", () -> new CustomWaterPlantFeature(WaterPlantConfiguration.CODEC));
